                ...
                {show && <>
                    ...
                    >
                        <motion.nav
                            ...
                            className='z-[200] h-[40%] flex px-5 a relative flex-col items-center overflow-hidden overflow-y-scroll w-full sm:rounded-2xl md:h-full rounded-t-3xl  md:rounded-none  sm:w-[500px] md:w-[400px] bg-white'
